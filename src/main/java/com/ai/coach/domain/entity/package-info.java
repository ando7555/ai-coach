 ...
 *
 * <p>Each class in this package maps to a node in the Neo4j graph database.
 * Relationships such as {@code HAS_PLAYER}, {@code PLAYS_FOR}, and
 * {@code ANALYSIS_FOR} capture the natural connections in a football domain.</p>
 *
 * <h2>Core entities</h2>
 * <ul>
 *   <li>{@link com.ai.coach.domain.entity.User} - Google-authenticated
 *       application user with role-based access.</li>
