...
I just added Java 9 modularity to my PitchMind app. It broke the build immediately.
...
I wrote a complete `module-info.java` for my PitchMind app. 17 `requires` directives. 10 `exports`. 10 `opens`. Hit build.
