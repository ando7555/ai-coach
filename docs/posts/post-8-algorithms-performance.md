...
**Title:** PitchMind — Post 8: Algorithms, Data Structures & System Design — A Performance Audit

---

I'm building an AI-powered football coaching app called **PitchMind** — Spring Boot 3.5, GraphQL, Neo4j, Google Gemini. After the [previous article](https://www.linkedin.com/pulse/design-patterns-in-spring-boot-andranik-muradyan) on design patterns, I turned the lens inward: a full performance audit of the codebase.
